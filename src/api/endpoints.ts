import type { Brand, Category, CompanyDetails, Product } from "../../types/types";

const baseAPI = import.meta.env.BASE_API;

export const getCompanyInfo = async (): Promise<CompanyDetails> => {
	const response = await fetch(`${baseAPI}/company`);
